...
public class PersonaRepositoryTest {
    ...
    public void test_persona_saved_ok_autowired(){
        ...
        // Assert
        assertEquals(personaSaved.getName(), persona1.getName());
        assertNotNull(personaSaved);
        assertNotNull(personaSaved.getId());
    }
    ...
    public void test_persona_saved_pepito(){
        ...
        Personas personaSaved =  personaRepositoryAutowired.save(persona1);
        // Assert
        assertEquals(personaSaved.getName(), "pepito");
    }
    ...
    public void testFindAll() {
        ...
        //verify(personaRepositoryMock.findAll(),times(2));
        // Assert
        assertEquals(listaPersonas.get(1).getName(), "juan" );
    }
    ...
    public void testFindById() {
        ...
        // Assert
        assertEquals(persFind1.get().getName(), "xxxx");
        assertEquals(persFind2.get().getName(), "yyyy");
        assertEquals(persFind3.get().getName(), "zzzz");
    }
